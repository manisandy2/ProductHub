# from project_test_to_mac.code.authtoken import auth_token
...
class Product:
    ...
    def product_get(self):
        # try:
        # print("TT",auth_token()["auth"]["access_token"])
        # print("Range",self.i)
        # print("head",self.headers)
        # print(self.link+str(self.i), headers=self.headers)
        # print(self.headers)
